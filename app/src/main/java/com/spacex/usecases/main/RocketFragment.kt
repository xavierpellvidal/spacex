...
import com.spacex.usecases.main.adapters.LaunchListAdapter
import com.spacex.usecases.main.viewmodels.RocketViewModel
...
class RocketFragment : Fragment() {
    ...
    private fun showRocketError(error: NetworkError) {
        when (error) {
            NetworkError.NULL_EMPTY_DATA -> showRocketUIError(getText(R.string.error_no_rockets))
            ...
            NetworkError.GENERIC_ERROR -> showRocketUIError(getText(R.string.error_something_wrong))
        }
    }

    private fun showLaunchesError(error: NetworkError) {
        when (error) {
            NetworkError.NULL_EMPTY_DATA -> showLaunchesUIError(getText(R.string.error_no_launches))
            NetworkError.NO_NETWORK -> {
            ...
            NetworkError.GENERIC_ERROR -> showLaunchesUIError(getText(R.string.error_something_wrong))
        }
    }
